...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'crypt client'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static const platform = const MethodChannel('channel.crypto.crypto');
  ...
  Future<void> getResponse() {
    ...
    //  _endMsg = _result;
    //_req = "http://10.0.2.2:3000/getHash?string=$_endMsg";
    //var response = http.get(_req);
    print(_endMsg);
    setState(() {
      //_res = response.body; //From Server
    });
  }
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          // how it positions its children. Here самолазов we use mainAxisAlignment to
